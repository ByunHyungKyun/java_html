...
<body>
<h2><a href="main_view.jsp"><img alt="안나와.." src="IMG/logo.jpg"></a>Member</h2>
<div class="container" id="container">
	<div class="form-container sign-up-container">
		<form action="#">
			<h1>가입할 회원을<br> 
				...
				<br>
			<div>
				<a href="#" class="social"><i class="fab fa-facebook-f"><img alt="안나와.." src="IMG/t.jpg" width="130" height="130"></i></a>
				<a href="#" class="social"><i class="fab fa-google-plus-g"><img alt="안나와.." src="IMG/m.jpg" width="130" height="130"></i></a><br>
				<h2>트레이너 &nbsp; &nbsp; &nbsp;회원</h2>
			</div>
			<!-- <br>
	...
	<div class="form-container sign-in-container">
		...
		<!-- 	<div class="social-container">
			...
			<button type="button" style="background-color: black;">로그인</button>
		</form>
	</div>
