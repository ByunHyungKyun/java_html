		...
		<form class="form-horizontal" id="fm">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<span id="spMemName" style="display: none;">한글 사용 가능. 2~5자리</span>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<span id="spMemPass" style="display: none;">영어소문자와 대문자와 특수기호와 숫자를 포함한 8~12자리</span>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					...
					<span id="spMemBir" style="display: none;">올바른 생년월일을 입력해주세요</span>
				</div>
			</div>
	...
	<div class="modal fade" id="zipModal" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					동입력: <input type="text" id="dong" name="dong2">
					<button type="button" onclick="searchZipCode2()" id="btnZip">검색</button>
					<hr>
					<div id="divZipResult" style="display: none;">
						<p>사용하실 주소를 더블클릭으로 선택해주세요</p>
						<table class="table table-striped" id="tbZipResult">
